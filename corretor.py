...
# def irmaoMeio(filhos, i):
#     tem_irmao_esquerda = False
#     tem_irmao_direita = False
#
#     indices_dir = range(1 + 1, len(filhos))
#     indices_esq = reversed(range(i - 1))
#
#     for j in indices_dir:
#         if filhos[j].classe not in settings.listSkipTags:
#             tem_irmao_direita = True
#             break
#     for k in indices_esq:
#         if filhos[k].classe not in settings.listSkipTags:
#             tem_irmao_esquerda = True
#             break
#     return tem_irmao_direita and tem_irmao_esquerda
